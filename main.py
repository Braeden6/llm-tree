...
def build_prediction_tree(input_text, depth=2, breadth=3):
...
def visualize_tree_plotly(tree):
    ...
    def add_nodes_edges(node, parent_id=None):
        ...
        if parent_id is None:
            ...
            label = f"{node['word']} ({node['prob']:.2f})"
...
def predict_word_tree(model_choice, input_text, tree_depth, tree_breadth):
...
with gr.Blocks() as demo:
    ...
    predict_btn.click(
        ...
        inputs=[model_dropdown, input_text, tree_depth, tree_breadth],
